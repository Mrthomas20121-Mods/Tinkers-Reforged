    ...
    public void preInit(FMLPreInitializationEvent e) {
        ...
        if(Loader.isModLoaded("appliedenergistics2") && ConfigModules.ae2) {
            if(Config.certus_quartz) {
                ...
                certus_quartz.addMaterialTrait(ArmorTraits.skeletal);
                certus_quartz.addMaterialTrait(ArmorTraits.calcic, ArmorMaterialType.CORE);
            ...
            if(Config.fluix_crystal) {
                ...
                fluix.addMaterialTrait(ArmorTraits.skeletal);
        ...
        if(Loader.isModLoaded("naturesaura") && ConfigModules.naturesaura) {
            if(Config.infused_iron) {
                ...
                infused_iron.addMaterialTrait(Traits.AURA_INFUSION);
                infused_iron.addMaterialTrait(ArmorTraits.magnetic2, ArmorMaterialType.CORE);
            ...
            if(Config.ancient_wood) {
                ...
                ancient_wood.addMaterialTrait(Traits.AURA_INFUSION);
        ...
        if(Loader.isModLoaded("atum") && ConfigModules.atum) {
            if(Config.limestone) {
                ...
                limestone.addMaterialTrait(ArmorTraits.cheap);
                limestone.addMaterialTrait(ArmorTraits.cheapskate);
            ...
            if(Config.khnumite) {
                ...
                khnumite.addMaterialTrait(ArmorTraits.cheap);
                khnumite.addMaterialTrait(ArmorTraits.cheapskate, ArmorMaterialType.PLATES);
        ...
        if((Loader.isModLoaded("astralsorcery") && ConfigModules.astral)) {
            ...
            starmetal.addMaterialTrait(Traits.astral);
            starmetal.addMaterialTrait(ArmorTraits.alien, ArmorMaterialType.PLATES);
        ...
        if(Loader.isModLoaded("mysticalworld") && ConfigModules.mysticalworld) {
            if(Config.amethyst) {
                ...
                amethyst.addMaterialTrait(ArmorTraits.calcic);
        ...
        if(Loader.isModLoaded("roots") && ConfigModules.roots) {
            if(Config.runestone) {
                ...
                runestone.addMaterialTrait(ArmorTraits.cheap);
