...
public class ConfigModule extends ConfigBase {
    ...
    public static boolean environementaltech = true;
    ...
    public void init() {
        ...
        environementaltech = this.getConfig().getBoolean("environementaltech", this.getCategory(), environementaltech, "Set to false to disable environementaltech module.");
        ...
        quark = this.getConfig().getBoolean("quark", this.getCategory(), quark, "Set to false to disable quark module.");
