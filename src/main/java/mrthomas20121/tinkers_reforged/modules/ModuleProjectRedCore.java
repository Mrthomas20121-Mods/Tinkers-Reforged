...
public class ModuleProjectRedCore implements ModuleBase {
    ...
    public void preInit(FMLPreInitializationEvent fmlPreInitializationEvent) {
        ...
        if(TinkersReforgedConfig.SettingMaterials.containMaterials(Resources.red_alloy.getMaterial().getIdentifier()))
        {
        ...
        if(TinkersReforgedConfig.SettingMaterials.containMaterials(Resources.electrotine.getMaterial().getIdentifier()))
        {
            ...
            Resources.electrotine.setMode(false);
        }
        if(TinkersReforgedConfig.SettingMaterials.containMaterials(Resources.electrotine_alloy.getMaterial().getIdentifier()))
        {
